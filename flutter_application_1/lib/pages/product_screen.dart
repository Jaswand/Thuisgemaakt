...
class _ProductScreenState extends State<ProductScreen> {
  ...
  List descriptionText = [
    'Full diet for all Chicken Lovers',
    'Specially made with chicken in handi, desi style',
    'Light & tasty for fitness freak, baked with love',
    'Delicious fish curry, you can enjoy with your all family members',
    'Dish included Kaju katli, samosas, gulab jamuns & rosogullas',
    'Get the great taste of paneer with butter paneer recepie',
    'Enjoy rice, chicken, salad complete full Diet Veg',
    'Pasta with whole roasted tomatoes',
    'Paneer Special- Made with paneer cubes & lots of seasonal vegetables',
    'Love of Bengal - Made real pure milk, soft spongy delicious',
    'Great aroma made with carrot, peas, beans, cashew & lots of love',
    'Very healthy & light with lots of vegetables inside.',
    'Made with eggs & secret special Indian spices',
    'Made with cottage cheese (paneer) & mixture of magic spices',
  ...
  List about = [
    ...
    'Specially made with chicken in handi',
    'desi style, Light & tasty for fitness freak',
    'baked with love',
    'Indian Sweet is a dish originating from the Indian subcontinent. It is common in the Indian subcontinent, Southeast Asia, Great Britain, Caribbean, and Japan. A typical curry from the Indian subcontinent consists of chicken stewed in an onion- and tomato-based sauce, flavoured with ginger, garlic, tomato puree, chilli peppers and a variety of spices, often including turmeric, cumin, coriander, cinnamon, and cardamom. Outside of South Asia, chicken curry is often made with a pre-made spice mixture known as curry powder.',
    'you can enjoy with your all family members',
    'Dish included Kaju katli, samosas, gulab jamuns & rosogullas',
    'Get the great taste of paneer with butter paneer recepie',
    'Enjoy rice, chicken, salad complete full Diet Veg',
    'Pasta with whole roasted tomatoes, Pasta is a dish originating from the Italy subcontinent. It is common in the Indian subcontinent, Southeast Asia, Great Britain, Caribbean, and Japan. A typical curry from the Indian subcontinent consists of chicken stewed in an onion- and tomato-based sauce, flavoured with ginger, garlic, tomato puree, chilli peppers and a variety of spices, often including turmeric, cumin, coriander, cinnamon, and cardamom. Outside of South Asia, chicken curry is often made with a pre-made spice mixture known as curry powder.',
    'Paneer Special- Made with paneer cubes & lots of seasonal vegetables',
    'Love of Bengal - Made real pure milk, soft spongy delicious',
    'Great aroma made with carrot, peas, beans, cashew & lots of love',
    'Very healthy & light with lots of vegetables inside.',
    'Made with eggs & secret special Indian spices, Egg curry is a popular non-veg dish of India, Pakistan and Bangladesh. Hope you will like it. For more Indian dishes, visit the Kitchen of WikiProject India.',
    'Made with cottage cheese (paneer) & mixture of magic spices',
    'Made with vegetables like carrot,'
  ];
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Image.asset('assets/images/${imagesSmall[index]}',
                                height: 20, width: 20),
                            const SizedBox(
                              width: 10.0,
                            ),
            ...
            // Popular Recipes -- Veder eraan werken
            Expanded(
              child: Padding(
                padding: const EdgeInsets.all(15.0),
                child: ListView.separated(
